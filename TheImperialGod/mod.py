...
class Mod(commands.Cog):
    ...
    async def kick_error(self, ctx, error):
        if isinstance(error, commands.MissingPermissions):
            ...
            embed.add_field(name = "Reason:", value = "`Kick Members Permission is missing!`")
            embed.add_field(name = "What to do:", value = f"Get a moderator to kick the person, or you!")
            await ctx.send(embed = embed)
    ...
    async def ban_error(self, ctx, error):
        if isinstance(error, commands.MissingPermissions):
            ...
            embed.add_field(name = "Reason:", value = "`Ban Members Permission is missing!`")
            embed.add_field(name = "What to do:", value = f"Get a moderator to ban the person, or you!")
            await ctx.send(embed = embed)
